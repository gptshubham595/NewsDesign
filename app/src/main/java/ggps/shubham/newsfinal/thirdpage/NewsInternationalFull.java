...
import ggps.shubham.newsfinal.secondpage.NewsInternational;

public class NewsInternationalFull extends AppCompatActivity {
    int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_international_full);
