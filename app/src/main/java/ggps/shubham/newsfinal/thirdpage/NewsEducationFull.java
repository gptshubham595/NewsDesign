...
import ggps.shubham.newsfinal.secondpage.NewsEducation;

public class NewsEducationFull extends AppCompatActivity {
    int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_education_full);
