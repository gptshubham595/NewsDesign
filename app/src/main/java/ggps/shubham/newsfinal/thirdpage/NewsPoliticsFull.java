...
import ggps.shubham.newsfinal.secondpage.NewsPolitics;

public class NewsPoliticsFull extends AppCompatActivity {
    int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_politics_full);
