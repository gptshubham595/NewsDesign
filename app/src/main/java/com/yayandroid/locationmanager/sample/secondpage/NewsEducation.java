...
import com.yayandroid.locationmanager.sample.thirdpage.NewsAgricultureFull;
import com.yayandroid.locationmanager.sample.thirdpage.NewsEducationFull;
import com.yayandroid.locationmanager.sample.thirdpage.NewsSportsFull;
import maes.tech.intentanim.CustomIntent;

public class NewsEducation extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_education);

        gestureDetector = new GestureDetector(this);
        Toast.makeText(getApplicationContext(),"Educational News Here",Toast.LENGTH_SHORT).show();
    ...
    private void onSwipeBottom() {
        ...
        Intent a=new Intent(getApplicationContext(),NewsBusiness.class);startActivity(a);
        CustomIntent.customType(this,"bottom-to-top");
    }
    private void onSwipeTop() {
        Toast.makeText(getApplicationContext(),"Down swipe",Toast.LENGTH_SHORT).show();
        Intent a=new Intent(getApplicationContext(),NewsInternational .class);startActivity(a);
    ...
    public boolean onDoubleTap(MotionEvent e) {
        Intent a = new Intent(getApplicationContext(),NewsEducationFull.class);
        startActivity(a);
