...
import com.yayandroid.locationmanager.sample.thirdpage.NewsInternationalFull;
import com.yayandroid.locationmanager.sample.thirdpage.NewsSportsFull;
import maes.tech.intentanim.CustomIntent;

public class NewsInternational extends AppCompatActivity implements GestureDetector.OnGestureListener ,GestureDetector.OnDoubleTapListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),"International News Here",Toast.LENGTH_SHORT).show();
