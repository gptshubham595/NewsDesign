...
import com.yayandroid.locationmanager.sample
.R;
import maes.tech.intentanim.CustomIntent;

public class MainScreenRight extends AppCompatActivity implements GestureDetector.OnGestureListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_screen_right);
