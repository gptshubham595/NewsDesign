...
public class NewsAgriculture extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),"Agriculture News Here",Toast.LENGTH_SHORT).show();
    ...
    public void  flippimage(int image){
        ...
        viewFlipper.setInAnimation(this,R.anim.slideinleft);
        viewFlipper.setOutAnimation(this,R.anim.slideoutright);
