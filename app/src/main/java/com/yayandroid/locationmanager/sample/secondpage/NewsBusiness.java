...
import com.yayandroid.locationmanager.sample.thirdpage.NewsBusinessFull;
import com.yayandroid.locationmanager.sample.thirdpage.NewsSportsFull;
import maes.tech.intentanim.CustomIntent;

public class NewsBusiness extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener{
...
private GestureDetector gestureDetector;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_business);

        gestureDetector = new GestureDetector(this);
        Toast.makeText(getApplicationContext(),"Business News Here",Toast.LENGTH_SHORT).show();
    ...
    private void onSwipeTop() {
        ...
        Intent a=new Intent(getApplicationContext(),NewsEducation .class);startActivity(a);
    ...
    public boolean onDoubleTap(MotionEvent e) {
        Intent a = new Intent(getApplicationContext(),NewsBusinessFull.class);
        startActivity(a);
