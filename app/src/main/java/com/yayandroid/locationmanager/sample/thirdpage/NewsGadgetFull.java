...
import com.yayandroid.locationmanager.sample.secondpage.NewsGadget;

public class NewsGadgetFull extends AppCompatActivity {
    int i=0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_news_gadget_full);
                ...
                handler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        if(i==1){Toast.makeText(getApplicationContext(),"One Click",Toast.LENGTH_SHORT).show();}
                            ...
                            Intent a =new Intent(getApplicationContext(),NewsGadget.class);
