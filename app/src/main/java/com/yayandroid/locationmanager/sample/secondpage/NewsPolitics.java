...
import com.yayandroid.locationmanager.sample.thirdpage.NewsPoliticsFull;
...
public class NewsPolitics extends AppCompatActivity implements GestureDetector.OnGestureListener,GestureDetector.OnDoubleTapListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(getApplicationContext(),"Political News Here",Toast.LENGTH_SHORT).show();
